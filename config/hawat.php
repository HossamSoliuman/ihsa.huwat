...
return [
     ...
     * /services، و"لوحة الإدارة" تحت /admin. App\Support\Nav يختار بينها
     * حسب اسم المسار.
     *
     * لوحة الإدارة وحدها خلف تسجيل الدخول: هي لوحة تطبيق حوات (الملاك
     * والدلالون والتجار…) وقائمتها تتبدّل مع دور المستخدم (nav_panel)، ومركز
     * المعلومات التشغيلي القديم (nav) صار قسم المدير العام فيها.
     *
    ...
    /*
     * مركز المعلومات التشغيلي — السجلات والعمليات. كان بوابة مستقلة على /admin
     * وصار قسم المدير العام في لوحة الإدارة؛ أسماء مساراته بلا بادئة كما كانت.
     */
    'nav' => [
        [
            'title' => 'عام',
