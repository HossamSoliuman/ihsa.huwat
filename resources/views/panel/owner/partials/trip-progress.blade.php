@php
    // شريط التقدّم كما في التطبيق: أربع خطوات فوق حالات الوزارة. الخطوة
    // الأخيرة "جاهزة للبيع" عند المالك و"اكتمل العد" عند الكابتن — تُمرَّر.
    $steps = $steps ?? ['بدأت الرحلة', 'بانتظار العدّاد', 'جارية العد', 'اكتمل العد وجاهزة للبيع'];
